...
// Social row: same block, order, labels and rel/target rules as xiom-lang.org
// (xiom-website/index.html). Icons are Simple Icons (CC0), inline so the page
// makes no external request; each anchor stays on one markup line.
const FOOTER_SOCIAL = `<div class="footer-social">
...
<footer class="site-footer">
  ...
  <div class="container footer-social-row">
    ${FOOTER_SOCIAL}
    <a href="mailto:registry@xiom-lang.org">registry@xiom-lang.org</a>
  </div>
